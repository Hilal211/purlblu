...
Please install and activate it before starting to use the theme Dazzle.
...
Theme documentation is available on https://dazzle.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Dazzle is Fontello.

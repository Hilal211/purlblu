...
if ( ! function_exists( 'dazzle_trx_addons_get_css' ) ) {
	add_filter( 'dazzle_filter_get_css', 'dazzle_trx_addons_get_css', 10, 2 );
	function dazzle_trx_addons_get_css( $css, $args ) {

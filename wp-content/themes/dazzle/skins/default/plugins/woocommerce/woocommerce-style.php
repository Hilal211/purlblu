...
if ( ! function_exists( 'dazzle_woocommerce_get_css' ) ) {
	add_filter( 'dazzle_filter_get_css', 'dazzle_woocommerce_get_css', 10, 2 );
	function dazzle_woocommerce_get_css( $css, $args ) {
...
$fdir = dazzle_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}

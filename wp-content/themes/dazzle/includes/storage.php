...
if ( ! function_exists( 'dazzle_storage_get' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_get( $var_name, $default = '' ) {
		global $DAZZLE_STORAGE;
		return isset( $DAZZLE_STORAGE[ $var_name ] ) ? $DAZZLE_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'dazzle_storage_set' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_set( $var_name, $value ) {
		global $DAZZLE_STORAGE;
		$DAZZLE_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'dazzle_storage_empty' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $DAZZLE_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $DAZZLE_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $DAZZLE_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $DAZZLE_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_isset' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $DAZZLE_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $DAZZLE_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $DAZZLE_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $DAZZLE_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_unset' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $DAZZLE_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			unset( $DAZZLE_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			unset( $DAZZLE_STORAGE[ $var_name ][ $key ] );
		} else {
			unset( $DAZZLE_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_inc' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_inc( $var_name, $value = 1 ) {
		global $DAZZLE_STORAGE;
		if ( empty( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = 0;
		}
		$DAZZLE_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'dazzle_storage_concat' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_concat( $var_name, $value ) {
		global $DAZZLE_STORAGE;
		if ( empty( $DAZZLE_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'dazzle_storage_get_array' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $DAZZLE_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $DAZZLE_STORAGE[ $var_name ][ $key ] ) ? $DAZZLE_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $DAZZLE_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $DAZZLE_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'dazzle_storage_set_array' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_set_array( $var_name, $key, $value ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$DAZZLE_STORAGE[ $var_name ][] = $value;
		} else {
...
if ( ! function_exists( 'dazzle_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function dazzle_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ][ $key ] ) ) {
			$DAZZLE_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( '' === $key2 ) {
			$DAZZLE_STORAGE[ $var_name ][ $key ][] = $value;
		} else {
			$DAZZLE_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
		}
	}
}

if ( ! function_exists( 'dazzle_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_merge_array( $var_name, $key, $value ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$DAZZLE_STORAGE[ $var_name ] = array_merge( $DAZZLE_STORAGE[ $var_name ], $value );
		} else {
			$DAZZLE_STORAGE[ $var_name ][ $key ] = array_merge( $DAZZLE_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			dazzle_array_insert_after( $DAZZLE_STORAGE[ $var_name ], $after, $key );
		} else {
			dazzle_array_insert_after( $DAZZLE_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function dazzle_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			dazzle_array_insert_before( $DAZZLE_STORAGE[ $var_name ], $before, $key );
		} else {
			dazzle_array_insert_before( $DAZZLE_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_push_array' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_push_array( $var_name, $key, $value ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $DAZZLE_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $DAZZLE_STORAGE[ $var_name ][ $key ] ) ) {
				$DAZZLE_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $DAZZLE_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'dazzle_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $DAZZLE_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $DAZZLE_STORAGE[ $var_name ] ) && is_array( $DAZZLE_STORAGE[ $var_name ] ) && count( $DAZZLE_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $DAZZLE_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $DAZZLE_STORAGE[ $var_name ][ $key ] ) && is_array( $DAZZLE_STORAGE[ $var_name ][ $key ] ) && count( $DAZZLE_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $DAZZLE_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'dazzle_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function dazzle_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( empty( $DAZZLE_STORAGE[ $var_name ][ $key ] ) ) {
			$DAZZLE_STORAGE[ $var_name ][ $key ] = 0;
		}
		$DAZZLE_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'dazzle_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function dazzle_storage_concat_array( $var_name, $key, $value ) {
		global $DAZZLE_STORAGE;
		if ( ! isset( $DAZZLE_STORAGE[ $var_name ] ) ) {
			$DAZZLE_STORAGE[ $var_name ] = array();
		}
		if ( empty( $DAZZLE_STORAGE[ $var_name ][ $key ] ) ) {
			$DAZZLE_STORAGE[ $var_name ][ $key ] = '';
		}
		$DAZZLE_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'dazzle_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $DAZZLE_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $DAZZLE_STORAGE[ $var_name ] ) ? $DAZZLE_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $DAZZLE_STORAGE[ $var_name ] ) ? $DAZZLE_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'dazzle_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function dazzle_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $DAZZLE_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $DAZZLE_STORAGE[ $var_name ]->$prop ) ? $DAZZLE_STORAGE[ $var_name ]->$prop : $default;
	}
}
